...
<link href="{{ asset('storage/carousel/dist/css/gallery.css') }}" rel="stylesheet">
<link href="{{ asset('storage/carousel/dist/css/gallery-keyframes-swipe.css') }}" rel="stylesheet">
<script src="{{ asset('storage/carousel/dist/js/gallery.js') }}"></script>
<style>
    .gallery {
        --gallery_width: 640px;
